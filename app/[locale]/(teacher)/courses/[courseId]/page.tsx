  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      <header className="space-y-5">
          ...
          <div className="min-w-0 space-y-2">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <Badge
                ...
                className={course.is_published ? "bg-success-tint text-success" : undefined}
              >
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-sm text-muted-foreground">
              ...
              <span>{course.price === "0.00" ? t("free") : formatPrice(course.price, locale)}</span>
            </div>
            {course.description && (
        ...
        <nav className="flex border-b border-border" aria-label={t("course_navigation")}>
