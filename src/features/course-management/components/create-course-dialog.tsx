...
import { createCourse, listSubjectsAction, listGradesAction, listStreamsAction } from "@/features/course-management/actions";
import { formValuesToCourseCreate, courseFormSchema } from "@/features/course-management/schema";
...
export function CreateCourseDialog({
  ...
  return (
    ...
    >
      <DialogTrigger render={<Button><Plus className="me-2 size-4" />{t("create")}</Button>} />
      <DialogContent>
        <DialogHeader>
