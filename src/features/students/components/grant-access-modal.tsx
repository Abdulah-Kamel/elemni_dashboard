      ...
      <div className="w-full max-w-md rounded-2xl bg-surface p-6 shadow-xl">
        ...
        <div className="mt-4">
          ...
          <select
            ...
            className="mt-1.5 block w-full rounded-lg border border-border bg-surface px-3 py-2 text-sm text-foreground outline-none transition-colors focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50"
          >
        ...
        <div className="mt-6 flex justify-end gap-2">
          ...
          <Button onClick={() => onConfirm(accessType)}>
            {t("confirm")}
          </Button>
        </div>
      </div>
